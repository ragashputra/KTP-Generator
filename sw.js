const CACHE_NAME = 'cetak-ktp-v58'; // UPDATE v58: perbaikan kualitas total "Tema Header" (v57) -- masalah utama v57 adalah tiap preset digambar SVG multi-warna tapi diterapkan lewat teknik CSS mask+currentColor, yg secara teknis MEMBUANG semua warna asli SVG-nya & cuma menyisakan siluet satu-warna polos (itu sebabnya masih kerasa generik/kurang "proper" walau motifnya sudah beda2). v58 mengganti fondasinya: header.top::before sekarang pakai background-image biasa (bukan mask), jadi tiap preset TAMPIL DGN WARNA ASLINYA SUNGGUHAN -- Aurora Rings (ring ungu/teal/magenta dgn glow radial di baliknya), Moiré Waves (2 set lingkaran konsentris ungu & teal yg sengaja tumpang tindih shg menciptakan efek interferensi moiré sungguhan, ganti total dari sekadar titik acak), Silk Lines (garis mesh dgn STROKE GRADIENT pink->putih sungguhan, bukan garis solid), Low Poly (facet segitiga penuh warna biru->emas spt pecahan kaca, bukan siluet putih), Hex Grid (honeycomb navy + SATU sel emas terisi penuh tiap ubin sbg aksen premium), & preset "Speed Lines" diganti konsepnya total jadi "Luxury Gold" (dasar hitam pekat + garis diagonal EMAS tipis + satu sapuan "shine" diagonal terang spt pantulan kilau logam/kaca, terinspirasi persis referensi "modern luxury shiny black with gold lines" yg dikirim user). Preview swatch di modal Pengaturan ikut diperbaiki jadi pakai SVG berwarna asli yg sama (bukan mask lagi) shg benar2 representatif thd tampilan header sungguhan sebelum diklik.
