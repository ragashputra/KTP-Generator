const CACHE_NAME = 'cetak-ktp-v65'; // UPDATE v65: FIX badge "Capella Honda" di pojok kanan header jadi susah/tak terbaca ketika duduk di atas tema header yg terang/warna-warni (mis. Glass Frost dgn blob hijau-cyan) -- sebelumnya --partner-bg cuma rgba putih ~5% opacity, nyaris transparan penuh, jadi warna latar header tembus & bikin teks gradient biru "Capella" + merah "Honda" nyaris hilang. Sekarang: backdrop-blur diperkuat (6px->14px + saturate), --partner-bg dikasih dark/light scrim yg cukup solid (dark:rgba(10,12,18,.42), light:rgba(255,255,255,.5)) independen dari warna background header, ditambah drop-shadow tipis di teks wordmark & eyebrow "INTERNAL TOOLS" biar kontras terjamin di background apapun. Kartu tetap kelihatan "kaca" (translucent+blur) tapi teks selalu terbaca. Hanya index.html yg berubah -- app.js, manifest.json, icon.svg tidak disentuh.
