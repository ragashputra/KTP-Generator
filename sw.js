const CACHE_NAME = 'cetak-ktp-v52'; // UPDATE v52: isi ruang kosong di sisi kanan header dgn brand partner mark "Capella Honda" -- menegaskan identitas perusahaan yg menaungi tools internal ini (PT Capella Dinamik Nusantara). Dibuat murni typographic/CSS (bukan file gambar/logo) -- wordmark "Capella" pakai gradient biru & "Honda" merah solid meniru skema 2 warna khas logo Honda tanpa mereproduksi bentuk grafis logo aslinya, dibungkus kartu pill tipis transparan (bukan solid) dgn border halus & backdrop-blur, otomatis kontras & konsisten baik di dark maupun light mode lewat token --partner-bg/--partner-border baru yg ditimpa per mode sama spt token lain.
