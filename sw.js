const CACHE_NAME = 'cetak-ktp-v71'; // UPDATE v71: FIX modal "Preview Hasil Crop" (tap thumbnail utk lihat versi besar) BELUM ikut menampilkan hasil "Sesuaikan Foto" -- beda dgn thumbnail grid & hasil cetak yg sudah dibenerin di v70, modal zoom ini masih pasang card.croppedDataURL APA ADANYA ke <img>, jadi kalau user sudah geser slider kecerahan/kontras/dll, preview besar di sini kelihatan seolah belum berubah (padahal card.adjust-nya sudah tersimpan & tetap kepakai saat cetak). Sekarang openZoomModal() proses ulang lewat applyManualAdjust() dulu (rumus sama persis dgn hasil cetak final) sebelum ditampilkan kalau ada penyesuaian aktif, ditambah keterangan teks di bawah preview yg menyebut "warna sudah disesuaikan manual" spy user yakin. Hanya app.js yg berubah -- index.html, manifest.json, icon.svg tidak disentuh.
